    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('web_site', models.URLField(blank=True, null=True, unique=True, verbose_name='url')),
                ('company_motto', models.CharField(blank=True, max_length=255, null=True, verbose_name='company_motto')),
                ('logo', models.ImageField(blank=True, upload_to='logo/%Y/%m/%d ', verbose_name='logo')),
            ],
        ),
        migrations.CreateModel(
            name='Client',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('full_name', models.CharField(blank=True, max_length=100, null=True, verbose_name='first_name')),
